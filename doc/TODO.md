...
更新日期：2026-09-16。唯一活动执行清单，按[决策 004](decisions/004-public-vsix-discovery.md)重整。原清单和完成记录见[归档](archive/2026-09-16-before-public-vsix-scope.md)，撤销不算完成。版本号仍为 0.2.0；公开发现与历史主路径已接入，下面区分已完成代码与待验收边界。
...
- [ ] REL-03：按用户要求更新对外安装/范围/恢复说明；README 本轮不改。提交、版本、CHANGELOG 和发布另需明确授权。

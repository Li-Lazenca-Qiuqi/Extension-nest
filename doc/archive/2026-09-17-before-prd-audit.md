# 2026-09-17 PRD 审查前待办快照

本文件仅用于追溯，活动执行清单仍为 [TODO](../TODO.md)。原清单混合实现与验收状态，以下状态不作为当前结论。

# 当前待办

更新日期：2026-09-16。唯一活动执行清单，按[决策 004](../decisions/004-public-vsix-discovery.md)重整。原清单和完成记录见[归档](2026-09-16-before-public-vsix-scope.md)，撤销不算完成。版本号已更新为 0.2.1；公开发现与历史主路径已接入，下面区分已完成代码与待验收边界。
